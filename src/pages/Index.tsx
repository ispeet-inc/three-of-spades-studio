      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center p-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl">
          <div className="text-center bg-secondary/20 backdrop-blur p-6 rounded-lg border border-border/30">
            ...
            <h3 className="text-lg font-semibold text-foreground mb-2">Premium Interface</h3>
            <p className="text-sm text-muted-foreground">Beautiful casino-quality design with smooth animations</p>
          </div>
          <div className="text-center bg-secondary/20 backdrop-blur p-6 rounded-lg border border-border/30">
            <div className="text-3xl mb-3">⚡</div>
            <h3 className="text-lg font-semibold text-foreground mb-2">Fast Gameplay</h3>
            <p className="text-sm text-muted-foreground">Quick and responsive card interactions</p>
          </div>
          <div className="text-center bg-secondary/20 backdrop-blur p-6 rounded-lg border border-border/30">
            <div className="text-3xl mb-3">👥</div>
            <h3 className="text-lg font-semibold text-foreground mb-2">Multiplayer Ready</h3>
            <p className="text-sm text-muted-foreground">Support for 4-player team-based gameplay</p>
          </div>
        </div>
      </div>
    </div>
