		...
		extend: {
			...
			keyframes: {
				...
				"bid-pulse": {
					...
					"50%": { transform: "scale(1.05)", boxShadow: "0 0 0 10px rgba(255, 215, 0, 0)" },
					"100%": { transform: "scale(1)", boxShadow: "0 0 0 0 rgba(255, 215, 0, 0)" },
				},
				"trump-selected": {
					"0%": { transform: "scale(1)", boxShadow: "0 0 0 0 rgba(255, 215, 0, 0.8)" },
					"25%": { transform: "scale(1.1)", boxShadow: "0 0 0 15px rgba(255, 215, 0, 0.4)" },
					"50%": { transform: "scale(1.05)", boxShadow: "0 0 0 25px rgba(255, 215, 0, 0.2)" },
					"100%": { transform: "scale(1)", boxShadow: "0 0 0 35px rgba(255, 215, 0, 0)" },
				},
				"victory-pulse": {
					"0%": { transform: "scale(1)" },
				...
				"game-win-celebration": {
					...
					"50%": { transform: "scale(1.1) rotate(-3deg)", filter: "hue-rotate(180deg)" },
					"75%": { transform: "scale(1.15) rotate(2deg)", filter: "hue-rotate(270deg)" },
